...
- Study module page with class-visible materials.
...
- Quiz Quotient updates after every completed quiz.
- XMKC Admin module builder with PDF/PPT/DOCX study material upload fields.
- XMKC Admin question maker with MCQ option boxes and correct-option dropdown.
